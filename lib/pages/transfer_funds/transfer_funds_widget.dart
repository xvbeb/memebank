    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        options: [
                          FFLocalizations.of(context).getText(
                            'mht2o1um' /* Internal Transfer */,
                          ),
                          FFLocalizations.of(context).getText(
                            'mwxy5z4g' /* External Transfer */,
                          ),
                          FFLocalizations.of(context).getText(
                            'u8h5fp8d' /* ACH Payment */,
                          )
                        ],
                        onChanged: (val) =>
                    ...
                    Padding(
                      ...
                      child: FlutterFlowDropDown<String>(
                        ...
                        options: [
                          FFLocalizations.of(context).getText(
                            '99ez60ng' /* Select Account */,
                          ),
                          FFLocalizations.of(context).getText(
                            '7j6oxl8b' /* Account ****2010 */,
                          ),
                          FFLocalizations.of(context).getText(
                            'x7kufofr' /* Account ****2011 */,
                          ),
                          FFLocalizations.of(context).getText(
                            'nw6fpj2e' /* Account ****2012 */,
                          )
                        ],
                        onChanged: (val) =>
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'ovmwigcf' /* Your new account balance is: */,
                            ),
          ...
          Text(
            FFLocalizations.of(context).getText(
              'tuyp9r2e' /* Tap above to complete transfer */,
            ),

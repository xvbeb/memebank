                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: Padding(
                          ...
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'dad03umo' /* Fill out the information below... */,
                            ),
                  ...
                  Padding(
                    ...
                    child: FlutterFlowDropDown<String>(
                      ...
                      options: [
                        FFLocalizations.of(context).getText(
                          'gzu1hlbf' /* Type of Appointment */,
                        ),
                        FFLocalizations.of(context).getText(
                          'sm5ikvo8' /* Doctors Visit */,
                        ),
                        FFLocalizations.of(context).getText(
                          'fttvwotz' /* Routine Checkup */,
                        ),
                        FFLocalizations.of(context).getText(
                          'cuuqk8p1' /* Scan/Update */,
                        )
                      ],
                      onChanged: (val) =>
